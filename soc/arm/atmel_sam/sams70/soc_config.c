...
/** @file
 * @brief System module to support early Atmel SAM S70 MCU configuration
 */
 ...
 * @return 0
 */
static int atmel_sams70_config(const struct device *dev)
{
#ifdef CONFIG_SOC_ATMEL_SAMS70_DISABLE_ERASE_PIN
...
SYS_INIT(atmel_sams70_config, PRE_KERNEL_1, 1);
